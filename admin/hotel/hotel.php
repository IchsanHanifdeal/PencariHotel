        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              <a href="hotel/hotel.php" class="nav-link active">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header d-flex justify-content-between align-items-end">
                <h3 class="card-title">Table hotel</h3>
                    ...
                    if ($resultd) {
                        ...
                        <tr>
                          ...
                          <td class="text-center">
                            <a class="btn btn-warning" href="edit.php?id_hotel=<?php echo $id; ?>"><i class="fas fa-edit"></i></a>
