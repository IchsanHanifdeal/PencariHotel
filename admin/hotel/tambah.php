<?php session_start(); require '../../backend/koneksi.php';?>
<?php
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO hotel (nama_hotel, alamat, latitude, longitude) VALUES ('$namahotel', '$alamat', '$latitude', '$longitude')";
                ...
                <div class="col-lg-8 mx-auto">
                    <div class="card shadow">
                        <div class="card-header bg-gradient-primary shadow-primary border-0">
                            <h6 class="text-white text-uppercase mb-0">Tambah Lokasi hotel</h6>
                        </div>
...
<script>
    ...
    if (marker) {
        const iconUrl = "../../plugins/house.png";
