  ...
  <nav class="navbar navbar-expand-lg fixed-top navbar-transparent " color-on-scroll="300">
    <div class="container">
      <div class="navbar-translate">
        <a class="navbar-brand" href="#" rel="tooltip" title="Pencari hotel" data-placement="bottom">
          Pencari hotel
        </a>
  ...
  <div class="page-header" data-parallax="true" style="background-image: url('plugins/landing/assets/img/daniel-olahh.jpg');">
    ...
    <div class="container">
      <div class="motto text-center">
        <h1>PencariHotel.id</h1>
        <h3>Aplikasi untuk mencari hotel kawasan Pekanbaru.</h3>
        <br />
      </div>
    </div>
  </div>
          ...
          <div class="col-md-4">
            <div class="card card-profile card-plain">
              ...
              <div class="card-body">
                <a href="#paper-kit">
                  <div class="author">
                    <h4 class="card-title">Satria Ihsan Wicaksono</h4>
                  </div>
                </a>
              </div>
            </div>
          ...
          <div class="col-md-4">
            <div class="card card-profile card-plain">
              ...
              <div class="card-body">
                <a href="#paper-kit">
                  <div class="author">
                    <h4 class="card-title">Melati Aulia</h4>
                  </div>
                </a>
              </div>
            </div>
          ...
          <div class="col-md-4">
            <div class="card card-profile card-plain">
              ...
              <div class="card-body">
                <a href="#paper-kit">
                  <div class="author">
                    <h4 class="card-title">Afriandy</h4>
                  </div>
                </a>
              </div>
            </div>
